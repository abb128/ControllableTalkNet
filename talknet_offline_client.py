...
def send_request(transcript, out_path, s_model, d_model, p_model):
...
if __name__ == "__main__":
    ...
    success = send_request(args.transcript, args.out_path, args.custom_model, args.d_model, args.p_model)
